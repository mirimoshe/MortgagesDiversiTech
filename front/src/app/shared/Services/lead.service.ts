...
export class leadService {
  ...
  sendLink(): string {
    return 'https://diversi-tech.github.io/mortgage-front/';
  }

  checkToken(id: number): Observable<HttpResponse<string>> {
    console.log(id, "token id");
    return this.http.get<string>(`${this.basicURL}Email/validate-magic-link/${id}`, { observe: 'response', responseType: 'text' as 'json' });
  }
}
